...
### Live chat 
Support Board allows you to embed a free live chat module on your website and let site visitors chat with you. 
...
* Marketing live chat: create emails or phone number lists, synchronize WooCommerce. Details [here](https://board.support/marketing).
* Automated chatbot: create powerful scenario with by connecting the Dialogflow chatbot. Details [here](https://board.support/bot).
...
It's fast and it works great. The Support Board administration area is a progressive web app that can be installed on Windows and Macs. 
...
Register a new account at [https://cloud.board.support/](https://cloud.board.support/).
...
From the WordPress admin area go to Settings > Support Board Cloud and insert the embed code of the chat (get it from https://cloud.board.support/account/).
...
Support Board provides a customer messaging platform for small and medium companies to help them scale their customers relationship. Live Chat and the chatbot are two of the main features but not the only ones. Give them a try!

= Who should use Support Board Live Chat? =

Support Board is perfect for agencies, business owners, small businesses, bloggers, designers, anyone with a WordPress website and wants to use live chat on their website.

= Do I need coding skills to use Support Board Wordpress plugin? =
...
The Support Board's paid tiers are built for those who send a large volume of messages. For more details, [view our pricing page](https://board.support/cloud/wordpress).
